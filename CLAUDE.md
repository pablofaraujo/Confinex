...
- A idempotência persistente de compras foi aplicada em 25/07/2026 por `supabase/migrations/202607250001_compras_idempotencia.sql`: compras antigas permaneceram com chave nula e RLS, políticas e permissões foram preservados. O cliente que reconcilia timeout e rejeita chave ligada a dados diferentes ainda não foi implantado no VPS. O contrato e a ordem segura de implantação estão em `docs/idempotencia-compras.md`.
