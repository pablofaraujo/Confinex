...
assert.match(html, /__CONFINEX_BUILD = "20260812-bases-online-2"/);
assert.match(deploy, /__CONFINEX_BUILD = "20260812-bases-online-2"/);
assert.match(deploy, /confinex-app\.mobile\.js\?v=20260812-bases-online-2/);
