...
assert.match(html, /__CONFINEX_BUILD = "20260812-bases-online-1"/);
assert.match(deploy, /__CONFINEX_BUILD = "20260812-bases-online-1"/);
assert.match(deploy, /confinex-app\.mobile\.js\?v=20260812-bases-online-1/);
